...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onLocationChanged(location);/**callback this function to store updates of location*/
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(this, "Location  Lat:" + myLat + "Lon" + myLon , Toast.LENGTH_SHORT).show();
            ...
            if (distance[0] < 150) { // If user location in less than the specified circle , ask for fingerprint
                Intent intent= new Intent(getApplicationContext(), LoginUser.class); //ask for fingerprint
